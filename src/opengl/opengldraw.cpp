 ...
 *                                setPixel                              *
 ************************************************************************/
void OpenGLDraw::setPixel(Surface* surface, int x, int y, 
      Uint8 red, Uint8 green, Uint8 blue, Uint8 alpha)
{
   SDL_Surface* sdlSurf = ((OpenGLSurface*) surface)->getSurface();
 ...
 *                                getPixel                              *
 ************************************************************************/
void OpenGLDraw::getPixel(Surface* surface, int x, int y, 
      Uint8& red, Uint8& green, Uint8& blue, Uint8& alpha)
{
   SDL_Surface* sdlSurf = ((OpenGLSurface*) surface)->getSurface();
 ...
 *                          doFilledRectangle                           *
 ************************************************************************/
void OpenGLDraw::doFilledRectangle(Surface* surface, int x1, int y1, 
      int x2, int y2)
{
 ...
 *                              doStampFill                             *
 ************************************************************************/
void OpenGLDraw::doStampFill(Surface* target, int tx1, int ty1,
      ...
      int sx2, int sy2, StampFillType stampType)
{
   ...
   SDL_Surface* targetSdl = ((OpenGLSurface*) target)->getSurface();
   SDL_Surface* sourceSdl = ((OpenGLSurface*) source)->getSurface();
 ...
 *                          doFreeTypeStamp                             *
 ************************************************************************/
void OpenGLDraw::doFreeTypeStamp(Surface* target, int x, int y, 
