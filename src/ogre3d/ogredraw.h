...
class OgreDraw : public Draw
{
   public:
      ...
      void doFilledRectangle(Surface* surface, int x1, int y1, int x2, int y2);
      ...
      void doFreeTypeStamp(Surface* target, int x, int y, FT_Bitmap* bitmap,
                           int left, int top);
   ...
   protected:
      ...
      /*! Set pixel directed to current pixel data position */
      void setPixel(Uint8* pixel, Ogre::PixelFormat pixelFormat,
            Uint8 red, Uint8 green, Uint8 blue, Uint8 alpha);
